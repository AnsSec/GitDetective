! function(t) { "use strict";
    t.fn.lightspeedBox = function(e) {
        ...
        function g(t) { if (1 === i) { t.originalEvent.touches && (t = t.originalEvent.touches[0]); var l = t.clientX - a,
                    r = t.clientY - s;
                (Math.abs(l) > e.swipeThreshold || Math.abs(r) > e.swipeThreshold) && (i = 2, n = l, o = r) } } var i = 0,
            a = 0,
            s = 0,
            n = 0,
            o = 0,
            l = this,
            r = { swipeThreshold: 70, useOnlyTouch: !0 }; return function() { e = t.extend(r, e), l.on("mousedown touchstart", c), t("html").on("mouseup touchend", u), t("html").on("mousemove touchmove", g) }(), l } }(jQuery);